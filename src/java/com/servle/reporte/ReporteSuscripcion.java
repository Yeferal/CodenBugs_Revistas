...
import com.revista.ReporteSuscripcionEditor;
 ...
 * @author yefer
 */
@WebServlet(name = "ReporteSuscripcion", urlPatterns = {"/ReporteSuscripcion"})
public class ReporteSuscripcion extends HttpServlet {

    SesionUsuario sesion = new SesionUsuario();
    ReporteSuscripcionEditor reporte = new ReporteSuscripcionEditor();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("page-reporte-suscripcion.jsp").forward(request, response);
    }
